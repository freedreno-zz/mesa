/* $Id: assyntax.h,v 1.16.2.1 2002/01/04 14:35:34 brianp Exp $ */
...
#if defined(__QNX__) || defined(Lynx) || (defined(SYSV) || defined(SVR4)) && !defined(ACK_ASSEMBLER) || defined(__ELF__) || defined(__GNU__) || defined(__GLUC__)
#define GLNAME(a)	a
#else
